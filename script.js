...
class Sport extends Car {
    constructor(model, trim, transmission, top, color, seatstrim, audio, wheelstrim, warranty, moonroof, enginetype, convertible, doors ) {
        super({model, trim, transmission, top, color, seatstrim, audio, wheelstrim, warranty })
        this.model = model;
        this.trim = trim;
        this.transmission = transmission;
        this.top = top;
...
var bigFactory = new Factory();
bigFactory.massBuild(35000, "Red Touring Mazda3's");
...
// Write your code below:
var yellowOptions = ['weather package', ' satellite radio', ' rear spoiler'];
bigFactory.customerBuild('yellow Touring Mazda3', yellowOptions);
...
var miataRf = new Sport ("Miata-RF", "Grand Touring", "manual", "hard top", "red", "leather", "premium", "premium");
console.log(miataRf);
...
var trailBlazer = new Truck('Trail Blazer', 'blue', 8, true, 'standard', true);
